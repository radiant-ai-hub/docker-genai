...
- [Installing the RSM-MSBA-GENAI-INTEL computing environment on macOS](#installing-the-rsm-msba-genai-intel-computing-environment-on-macos)
- [Updating the RSM-MSBA-GENAI-INTEL computing environment on macOS](#updating-the-rsm-msba-genai-intel-computing-environment-on-macos)
...
## Installing the RSM-MSBA-GENAI-INTEL computing environment on macOS
...
cp -p ~/git/docker-genai/launch-rsm-msba-genai-intel.sh ~/Desktop/launch-rsm-msba.command;
...
The code above also copies the file `launch-rsm-msba-genai-intel.sh` to `launch-rsm-msba.command` on your Desktop. You will be able to double-click this file to start the container again in the future.
...
## Updating the RSM-MSBA-GENAI-INTEL computing environment on macOS
