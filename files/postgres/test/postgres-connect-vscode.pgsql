...
source <(curl -s https://raw.githubusercontent.com/radiant-ai-hub/docker-genai/refs/heads/main/files/postgres/postgres-createdb.sh)
...
and choose rsm-genai and check if any of the below statements work
